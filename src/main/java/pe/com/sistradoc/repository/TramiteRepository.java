...
public interface TramiteRepository extends JpaRepository<Tramite, Long> {
	...
	@Query(value = "SELECT upper(a.TXT_NOMB_AREA) as 'area', upper(d.TXT_NOMB_DEPE) AS 'dependenciaActual' ,  \r\n"
			...
			+ "                                                           )  \r\n"
			+ "                                                          )  \r\n"
			+ "GROUP BY upper(a.TXT_NOMB_AREA), upper(d.TXT_NOMB_DEPE)  \r\n"
			+ "ORDER BY COUNT(t.TXT_CODI_TRAM) desc , upper(a.TXT_NOMB_AREA) asc , upper(d.TXT_NOMB_DEPE) asc  "
	     , nativeQuery = true)
